...
--Q. What are the top 3 values from invoice?
...
--Q. Write a query to return the email, first name, last name and Genre of all Rock Music listeners.
...
--Q. Let's invite the artist who have written the most rock music in our dataset
...
--Return the Name and Milliseconds for each track. Order by the longest songs listed first.
